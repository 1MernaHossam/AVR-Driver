...
#define DIO_PIN_DIR_10    DIO_INPUT//INT2
#define DIO_PIN_DIR_11    DIO_OUTPUT
#define DIO_PIN_DIR_12    DIO_INPUT/*ss:input floating*/
#define DIO_PIN_DIR_13    DIO_INPUT/*mosi:input*/
#define DIO_PIN_DIR_14    DIO_OUTPUT/*miso:output*/
#define DIO_PIN_DIR_15    DIO_INPUT/*sck:input*/
...
#define DIO_PIN_DIR_26    DIO_INPUT//INT0
#define DIO_PIN_DIR_27    DIO_INPUT//INT1
